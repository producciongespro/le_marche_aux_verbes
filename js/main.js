...
function cargarFondos() {
  ...
  switch (modo) {
    ...
    break;
    case 2:
      $("#contenedor_fondos").attr("src","img/fondo_pantalla_futuro.jpg");
    break;
    case 3:
      $("#contenedor_fondos").attr("src","img/fondo_pantalla_pasado.jpg");
    break;
    default:
...
function cargarAudioVerbos(lista) {
  switch (modo) {
    ...
    case 2:
      ...
      for (var i = 0; i < totalCartas; i++) {
      $(".grupo_audios").append("<audio class='audios'  preload='auto' src='audio/"+ modificarC.getNombreArchivo(lista[i].pre) +".mp3'  id='"+ modificarC.getNombreArchivo(lista[i].pre) +"'></audio>");
      $(".grupo_audios").append("<audio class='audios'  preload='auto' src='audio/"+ modificarC.getNombreArchivo(lista[i].fut) +".mp3'  id='"+ modificarC.getNombreArchivo(lista[i].fut) +"'></audio>");
    }
    break;
    case 3:
